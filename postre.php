...
// VARIABLES DINÁMICAS
$titulo = "POSTRE";
$descripcion = "El postre es una preparación dulce que forma parte del cierre de la comida.
En cada estado, los postres tradicionales suelen elaborarse con frutas regionales, miel, piloncillo o maíz, 
lo que los convierte en una expresión más de la identidad gastronómica local y de las tradiciones culinarias del estado.";

$imagen = "img/2platillos/POSTRES.png";
$volver = "index.php"; // Cambia esto si tienes otra página
?>
